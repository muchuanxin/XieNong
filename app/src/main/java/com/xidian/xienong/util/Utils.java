...
public class Utils {
	 ...
	 * @return
	 */
	public synchronized static LatLonPoint getLocationResult(AMapLocation location){
		if(null == location){
			return null;
		}
	 ...
	 * @return
	 */
	public synchronized static String getLocationCity(AMapLocation location){
		if(null == location){
			return null;
		}
		StringBuffer sb = new StringBuffer();
	...
	public synchronized static List getLocation(AMapLocation location){
		if(null == location){
			return null;
		}
