...
public class RecyclerDecoration extends RecyclerView.ItemDecoration{
     ...
     */
    public RecyclerDecoration(Context context, int orientation, int drawableId) {
     ...
     */
    public RecyclerDecoration(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
