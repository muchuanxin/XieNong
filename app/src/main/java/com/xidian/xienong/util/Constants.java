...
public class Constants {
    ...
    public static final String HAS_CANCLED_BY_FARMER = "has_cancled_by_farmer";//农户取消
    public static final String HAS_EVALUATED_BY_FARMER = "has_evaluated_by_farmer";//农户已评价
    public static final String HAS_AGREE_OR_REFUSE_BY_FARMER = "has_agree_or_refuse_by_farmer";//
    public static final String GRAB_ORDER_FAIL_ACTION = "grab_order_fail_action";//多个人同时抢单，农机抢单失败
    ...
    //me_uploadHeadPhoto
    public static String uploadHeadImage = Url.UploadHeadPhoto + "?";
    ...
    //machineTrademark
    public static List<MachineTrademark> machineTrademark = new ArrayList<MachineTrademark>();
    public static String UploadSomeMachineImage = Url.UploadSomeMachineImage + "?";
