...
public class ChangeAddressActivity extends AppCompatActivity {
    ...
    private void initEvent() {
        ...
        rl_address.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(ChangeAddressActivity.this, AreaProvinceActivity.class), 1234);
            }
        });
            ...
            public void onClick(View v) {
                ...
                if (!"".equals(name_str) && !"".equals(telephone_str) && !"请选择".equals(address_str) && !"".equals(address_detail_str)){
                    if (telephone_str.length()==11 && telephone_str.startsWith("1")){
                        ...
                        SharePreferenceUtil sp = new SharePreferenceUtil(ChangeAddressActivity.this, Constants.SAVE_USER);
                        ...
                        httpUrl.post(Url.ModifyMyAddress, map, new BaseCallback<String>() {
                            @Override
                            public void onRequestBefore() {
                                Log.i("mcx", "ModifyMyAddress : " + Url.ModifyMyAddress);
                            }
                            ...
                            public void onSuccess(Response response, String resultResponse) {
                                ...
                                try {
                                    ...
                                    if (result.equals("SUCCESS")) {
                                        ToastCustom.makeToast(ChangeAddressActivity.this, "修改成功");
                                        finish();
                                    }
                                    else {
                                        ToastCustom.makeToast(ChangeAddressActivity.this, "修改失败");
                                    }
                        ...
                        ToastCustom.makeToast(ChangeAddressActivity.this, "请填写正确的手机号");
                    }
                }
                else {
                    ToastCustom.makeToast(ChangeAddressActivity.this, "请填写信息");
                }
            }
        });
    }
    ...
    private void initData() {
        ...
        address_detail.setText(intent.getStringExtra("address_detail"));
    }
